...
#     Live docroot per SRE deploy evidence (MAC-220, 2026-09-08; first noted
#     MAC-86, 2026-09-06, Hostinger account finding): on this account the
...
#     and MAC-220 live deploy). Override HOSTINGER_FTP_REMOTE_DIR only for
#     other accounts.
...
for arg in "$@"; do
  case "$arg" in
    ...
    --help|-h)
      ...
      echo "Live docroot per MAC-220 SRE evidence — the FTP login dir"
      echo "  /public_html (DO_NOT_UPLOAD_HERE marker) is NOT live. Override:"
