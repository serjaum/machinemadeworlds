...
#   HOSTINGER_FTP_PORT (default 21), HOSTINGER_FTP_PROTOCOL (ftp|sftp|ftps), HOSTINGER_FTP_REMOTE_DIR (default domains/machinemadeworlds.com/public_html)
#   Live docroot (MAC-305): /domains/machinemadeworlds.com/public_html — not the FTP login dir /public_html.
